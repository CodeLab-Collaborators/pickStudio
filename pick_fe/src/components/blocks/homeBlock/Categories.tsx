...
const Categories = () => {
  ...
  return (
    <div className={`w-screen transition-all py-3 max-md:py-0 ease-in-out duration-200 z-20 max-[740px]:border-b-[1px] max-[740px]:shadow flex justify-center ${shadow && "shadow-md" }`}>
      <div className="w-[90%] flex items-center justify-between h-full gap-4">
        <div className="w-[45%]  flex-1 max-[740px]:w-full h-full relative">
          ...
          <div
            ref={ref}
            className= "w-full  m-[auto] h-full flex gap-11 items-center  overflow-y-scroll no-scrollbar">

...
const StudioPrice = () => {
  ...
  const handleStudioPrice = (e:any)=>{
    setStudioPrice(e.target.value)
  }
...
/>
    ...
    <input id="bordered-checkbox" checked={includeDiscount} onChange={handleCheckboxChange} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-100 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
    <label htmlFor="bordered-checkbox" className="w-full py-4 ms-2 text-base text-gray-900 font-normal ">Add Discount</label>
</div>
        ...
        {includeDiscount && (
          <div className="mt-2 flex justify-center items-center flex-col">
            ...
            <input
              ...
              className="w-[22%] p-2  bg-white rounded-md mt-1 placeholder:text-gray-600 placeholder:font-semibold"
              placeholder='90'
            />

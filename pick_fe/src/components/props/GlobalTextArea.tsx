...
const GlobalTextArea: React.FC<GlobalInputProps> = ({
  className,
  style,
  inputType,
  ...props
  ...
  const inputClasses =
    "peer h-10 w-full border-none font-normal resize-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm ";
  ...
  return (
    <label className={containerClassList}>
      <textarea style={style} className={inputClasses} />

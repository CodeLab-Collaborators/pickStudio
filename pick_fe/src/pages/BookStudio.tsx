...
import { Header, MobilePriceDetails, Payment, StickyPrice, UserPurchase } from '../components/blocks/BookStudio'
...
document.title = `Request to book ${singleStudio?.studioName}`
  return (
       ...
       <div className="h-screen flex bg-white justify-center w-screen overflow-x-hidden">

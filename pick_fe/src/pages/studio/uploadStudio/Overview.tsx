...
document.title= "Create your listing - Pickastudio"
       ...
       {/* title */}
        ...
        <div className='w-full h-[80%] m-auto grid grid-rows-3 gap-10'>
          ...
          <div className='grid grid-cols-[.1fr,1fr,.3fr] gap-5'>
            ...
            <div className=''>
              <h1 className='text-xl font-semibold'>Tell us about your studio</h1>
              <p className='text-lg font-normal mt-3 text-gray-600 leading-tight'>Share some basic info, like the studio location and how many people it can contain.</p>
            </div>
          ...
          <div className='grid grid-cols-[.1fr,1fr,.3fr] gap-5'>
            ...
            <div className=''>
              ...
              <p className='text-lg font-normal mt-3 text-gray-600 leading-tight'>Add 5 or more photos of your studio plus a title and description—we’ll help you out.</p>
            </div>
            <div className='bg-slate-500 h-full w-full'>
              <img src="" alt="image" className='object-contain'  />
            </div>
 ...
 Set a starting price, and publish your listing.</p>
            </div>
            <div className='bg-slate-500 h-full w-full'>
              <img src="" alt="image" className='object-contain'  />
            </div>
